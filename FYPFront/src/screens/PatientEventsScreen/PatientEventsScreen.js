...
const PatientEventsScreen = () => {
    ...
    const getAppointments = async () => {
        try {
            ...
            const response = await axios.get('https://ouvatek.herokuapp.com/api/showappointmentspatient', {
    ...
    const deleteAppointment = async (appointment) => {
        try {
            Alert.alert(
                'Delete Appointment ',
                `Are you sure you want to delete the appointment with Doctor ${appointment.first_name} ${appointment.last_name} on ${appointment.appointment_date} From ${appointment.appointment_start_time} - To ${appointment.appointment_end_time} ?`,
                [
                    {
                        text: 'Cancel',
                        style: 'cancel'
...
export default PatientEventsScreen;
